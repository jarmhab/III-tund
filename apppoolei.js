(function(){
  ...
  Moosipurk.prototype = {
    ...
    updateMenu: function(){
      ...
      //kui on menüül klass active-menu siis võtame ära
      document.querySelector('.active-menu').className = document.querySelector('.active-menu' + this.currentRoute).className.replace(' active-menu', '');
